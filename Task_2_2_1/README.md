...
*Рис. 1. Представление пиццерии. Детальное описание классов представлено ниже*
...
> Если в списках bakerSpeeds или carrierCapacities меньше значений, чем работников, для остальных используется значение
> по умолчанию 1.
